...
$routes = [
    ...
    '/user/services/marriage/submit' => ['UserController', 'submitMarriage'],
    '/user/services/conversion-form' => ['UserController', 'conversionForm'],
    '/user/services/conversion/submit' => ['UserController', 'submitConversion'],
    ...
    '/admin/dawah/marriage/approve'   => ['AdminController', 'approveMarriage'],
    '/admin/dawah/marriage/reject'    => ['AdminController', 'rejectMarriage'],
    '/admin/dawah/conversion'         => ['AdminController', 'dawahConversion'],
    '/admin/dawah/conversion/approve' => ['AdminController', 'approveConversion'],
    '/admin/dawah/conversion/reject'  => ['AdminController', 'rejectConversion'],
