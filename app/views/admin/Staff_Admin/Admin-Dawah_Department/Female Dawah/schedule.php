...
<head>
  ...
  <style>
    ...
    .calendar-header { padding: 20px; background: var(--female-light); border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center; }
    .month-title { font-family: 'Lora', serif; font-size: 1.1rem; font-weight: 700; color: var(--female-dark); margin: 0; }
    .cal-nav { display: flex; gap: 8px; }
    .cal-nav-btn { background: white; border: 1px solid var(--border); width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; cursor: pointer; color: var(--female-dark); transition: all 0.2s; }
    .cal-nav-btn:hover { border-color: var(--female-accent); color: var(--female-accent); }
    ...
    .cal-date:hover { background: var(--female-light); color: var(--female-accent); }
    .cal-date.today { background: var(--female-accent); color: white; }
    .cal-date.selected { border: 2px solid var(--female-accent); color: var(--female-accent); }
    ...
    .day-header { padding: 16px 24px; background: var(--female-light); border-bottom: 1px solid var(--border); display: flex; justify-content: space-between; align-items: center; }
    .day-title { font-family: 'Lora', serif; font-size: 1.1rem; font-weight: 700; color: var(--female-dark); margin: 0; }
    ...
    .time-slot { width: 90px; flex-shrink: 0; font-weight: 800; color: var(--female-accent); font-size: 0.95rem; }
    ...
    <div class="main-content">
      <div class="top-bar">
        <div style="display: flex; align-items: center; gap: 16px;">
          ...
          <div>
            <div class="top-bar-title">Service Schedule (Female)</div>
            <div class="top-bar-subtitle">Monitor and coordinate all sisters' appointments</div>
          </div>
        </div>
      </div>
      <div class="page-body">
          ...
          <div id="schedule-timeline">
            ...
            <div id="selection-context" style="display: none; background: white; padding: 16px 24px; border-radius: 16px; border: 1px solid var(--border); margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center;">
               <div style="flex: 1;">
                 ...
                 <div id="selected-date-label" style="font-size: 1.1rem; font-weight: 800; color: var(--female-dark);">—</div>
               </div>
               <div style="display: flex; gap: 12px; align-items: center;">
                 <input type="text" id="unavail-reason-input" placeholder="Enter reason (e.g. Public Holiday)" style="display: none; padding: 10px 14px; border-radius: 10px; border: 1.5px solid var(--female-accent); font-size: 0.85rem; width: 240px; outline: none;" />
