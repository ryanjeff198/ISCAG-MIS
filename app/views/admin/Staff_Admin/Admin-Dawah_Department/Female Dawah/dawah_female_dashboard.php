...
<head>
  ...
  <style>
    ...
    .insight-card:hover { transform: translateY(-4px); box-shadow: 0 12px 24px rgba(0,0,0,0.08); border-color: #be185d; }
    .insight-label { font-size: 0.75rem; font-weight: 700; color: var(--text-muted); text-transform: uppercase; letter-spacing: 0.05em; }
    .insight-value { font-size: 1.8rem; font-weight: 800; color: #831843; line-height: 1; }
    ...
    .tab-btn.active { color: #be185d !important; border-bottom-color: #be185d !important; }

    /* Female Department Branding */
    :root {
        --female-accent: #be185d;
        --female-light: #fdf2f8;
    }
    .top-bar-title { color: #831843; }
  </style>
</head>
<body>
      ...
      <div class="top-bar">
        <div style="display: flex; align-items: center; gap: 16px;">
          ...
          <div>
            ...
            <div class="top-bar-subtitle">Managing religious services and community support</div>
          </div>
        </div>
      </div>
      <div class="page-body">
        <div class="breadcrumb-bar">
          <span class="current" style="color: var(--female-accent);">Female Da'wah Dashboard</span>
        </div>

        <div class="admin-insights">
          <div class="insight-card">
            <div class="insight-label">Female Counseling</div>
        ...
        <div class="section-card">
          <div class="section-card-header">
            <h6 style="color: #831843;">Service Request Overview (Female)</h6>
          </div>
    ...
    function renderTable(filter = 'all') {
      ...
      tbody.innerHTML = filtered.map(r => `
        <tr>
          ...
          <td>
            <button class="btn-action" style="color:#be185d;">Process Request</button>
          </td>
        </tr>
      `).join('');
    }
