...
<head>
  ...
  <title>ISCAG MIS — Female Da'wah Notifications</title>
    ...
    <div class="main-content">
      ...
      <div class="page-body">
        <div class="breadcrumb-bar">
          <span class="current">Female Da'wah Notifications</span>
        </div>
  ...
  <script>
    ...
    function getSourcePage(type) {
      const map = {
        ...
        profile: '<?= url("/admin/dawah/female/profile") ?>'
      };
      return map[type] || '<?= url("/admin/dawah/female") ?>';
    }
    ...
    function getStaffNotifications() {
      ...
      const markedReadTime = parseInt(localStorage.getItem('female_dawah_notifs_read') || '0', 10);
        ...
        <div class="detail-card">
          ...
          <div class="detail-meta-grid">
            ...
            <div class="detail-meta-item">
              ...
              <div class="detail-meta-value">Female Da'wah</div>
            </div>
          </div>
    ...
    function markAllRead() {
      localStorage.setItem('female_dawah_notifs_read', Date.now().toString());
      const container = document.getElementById('notif-container');
