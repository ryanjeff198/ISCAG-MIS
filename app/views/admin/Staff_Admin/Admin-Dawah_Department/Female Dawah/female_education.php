    ...
    <div class="main-content">
      <div class="top-bar">
        <div style="display: flex; align-items: center; gap: 16px;">
          ...
          <div>
            <div class="top-bar-title">Female Islamic Education Records</div>
      ...
      <div class="page-body">
        ...
        <div style="margin-bottom: 20px; display: flex; justify-content: flex-end;">
          <button class="btn-action" style="background: var(--female-accent); color: white; padding: 10px 20px; border-radius: 10px; border: none; font-weight: 700; cursor: pointer; display: flex; align-items: center; gap: 8px; box-shadow: 0 4px 12px rgba(212, 175, 55, 0.25);">
        ...
        <div class="section-card">
          <div class="section-card-header">
            <h6 style="color: var(--female-dark); margin: 0;">
              <svg viewBox="0 0 24 24" style="width:20px;height:20px;fill:var(--female-accent);margin-right:8px;"><path d="M12 3L1 9l11 6 9-4.91V17h2V9L12 3zM5 13.18v4L12 21l7-3.82v-4L12 17l-7-3.82z"/></svg>
                  ...
                  <?php else: ?>
                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          <button class="btn-action" style="color: var(--female-accent);">Manage</button>
                        </td>
                      </tr>
                    <?php endforeach; ?>
                  <?php endif; ?>
