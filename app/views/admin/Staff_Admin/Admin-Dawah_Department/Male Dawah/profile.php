    ...
    <div class="main-content">
      <div class="top-bar">
        <div class="top-bar-left">
          ...
          <div class="top-bar-subtitle">Male Da'wah Department — Manage your staff account and departmental settings</div>
        </div>
          ...
          <div style="padding:0 28px 24px; position:relative; z-index:2;">
            <div style="display:flex;align-items:flex-end;gap:20px;margin-top:-44px;margin-bottom:16px;flex-wrap:wrap;">
              ...
              <div style="flex:1;min-width:220px;padding-top:48px;">
                <h4 style="font-family:'Lora',serif;font-weight:700;color:var(--text-main);margin:0;font-size:1.15rem;"><?= ($dbUser['first_name'] ?? '') . ' ' . ($dbUser['last_name'] ?? '') ?: 'Male Da\'wah Staff' ?></h4>
                <p style="color:var(--text-muted);font-size:0.83rem;margin:0;"><?= $dbUser['email'] ?? 'male.dawah@iscag.org' ?></p>
                <div style="display:flex;gap:8px;flex-wrap:wrap;margin-top:12px;">
                  <span class="info-badge" style="background:rgba(23, 107, 69, 0.1);color:var(--primary);">Male Da'wah Section Head</span>
        ...
        <div class="section-card">
          ...
          <div class="section-card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
              <div><label class="form-label" style="color:var(--text-muted);font-size:0.75rem;font-weight:700;text-transform:uppercase;">Staff ID</label><p style="font-weight:600;margin-top:4px;"><?= $dbUser['tenant_id'] ?? 'STF-M01' ?></p></div>
              <div><label class="form-label" style="color:var(--text-muted);font-size:0.75rem;font-weight:700;text-transform:uppercase;">Administrative Role</label><p style="font-weight:600;margin-top:4px;">Male Da'wah Head</p></div>
            </div>
          </div>
        </div>
      </div>
