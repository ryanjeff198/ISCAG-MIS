    ...
    <div class="main-content">
      <div class="top-bar">
        <div class="top-bar-left">
          ...
          <div class="top-bar-subtitle">Male Da'wah Department — Data-driven insights for religious services</div>
        </div>
      ...
      <div class="page-body">
        ...
        <div class="admin-insights">
          ...
          <div class="insight-card">
            ...
            <div class="insight-value" style="color:var(--accent);"><?= $marriage['total'] ?? 0 ?></div>
            <div class="kpi-trend up">
               <svg viewBox="0 0 24 24" style="width:14px;height:14px;fill:currentColor;"><path d="M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z"/></svg>
               <?= $mAppRate ?>% Finalized
            </div>
        ...
        <div style="display:grid; grid-template-columns: 1fr 1fr; gap:24px;">
          ...
          <div class="section-card">
            <div class="section-card-header">
              <h6>
                <svg viewBox="0 0 24 24" style="width:18px;height:18px;fill:var(--accent);margin-right:8px;"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2v-4h2v4z"/></svg>
          ...
          <div class="section-card">
            ...
            <div class="section-card-body">
              <p style="font-size:0.85rem; color:var(--text-muted); line-height:1.6; margin:0;">
                ...
                ?></strong> category. 
                This data helps the Male Da'wah department allocate resources and tailor curricula to the specific needs of different age groups.
              </p>
            </div>
          </div>
        </div>
