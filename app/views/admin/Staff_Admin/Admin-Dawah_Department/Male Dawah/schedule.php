...
<body>
    ...
    <div class="main-content">
      <div class="top-bar">
        <div class="top-bar-left">
          ...
          <div class="top-bar-subtitle">Male Da'wah Department — Monitor and coordinate all departmental appointments</div>
        </div>
          ...
          <div class="timeline-column">
            ...
            <div class="day-card">
              <div class="day-header">
                <h6 class="day-title" id="selected-day-title">Today, May 02</h6>
  ...
  <script>
    ...
    function addToTimeline(dateStr, html) {
      ...
      // Find or create a day-group for this date
      ...
      // Remove the "No appointments" placeholder if present
    ...
    async function submitBlock(e) {
      ...
      try {
        ...
        if (result.success) {
          ...
          renderCalendar();
          // Add blocked notice to timeline
          addToTimeline(date, `
    ...
    async function submitAssignment(e) {
      ...
      try {
        ...
        if (result.success) {
          ...
          renderCalendar();
          // Add new event to timeline immediately
