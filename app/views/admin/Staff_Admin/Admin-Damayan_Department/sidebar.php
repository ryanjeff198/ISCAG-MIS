<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-header">
    <div class="sidebar-brand">
      ...
      <div class="brand-text"><strong>ISCAG MIS</strong><span>Damayan Staff</span></div>
    </div>
  </div>
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= url('/admin/mis_admin/damayan_records') ?>" class="nav-item <?= ($active_page ?? '') == 'records' ? 'active' : '' ?>" data-tooltip="Burial Records">
