<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-user">
    <div class="user-avatar" id="nav-avatar" style="background:var(--danger-light);">
  ...
  <nav class="sidebar-nav">
    ...
    <div class="nav-section-label">Burial Services</div>
    <a href="<?= url('/admin/damayan/records') ?>" class="nav-item <?= ($active_page ?? '') == 'records' ? 'active' : '' ?>" data-tooltip="Burial Records">
