...
<body>
          ...
          <div style="padding:0 28px 24px; position:relative; z-index:2;">
            <div style="display:flex;align-items:flex-end;gap:20px;margin-top:-44px;margin-bottom:16px;flex-wrap:wrap;">
              <div style="flex-shrink:0;text-align:center;">
                ...
                <button onclick="document.getElementById('avatar-input').click()" style="margin-top:8px;padding:5px 12px;border-radius:6px;border:none;background:var(--damayan-accent);color:white;font-size:0.75rem;font-weight:700;cursor:pointer;">Edit Photo</button>
            ...
            <div style="display:flex;gap:10px;">
              <button id="edit-btn" style="font-size:0.82rem;padding:8px 18px;border-radius:8px;border:none;background:var(--damayan-accent);color:white;font-weight:700;cursor:pointer;">Update Profile</button>
            </div>
          </div>
        </div>
          ...
          <div class="section-card-body">
            <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;">
              <div class="service-card">
                ...
                <div><div style="font-weight:700;font-size:0.9rem;">Burial Services</div></div>
              </div>
              <div class="service-card">
                ...
                <div><div style="font-weight:700;font-size:0.9rem;">Charity Programs</div></div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="section-card">
          ...
          <div class="section-card-body">
            <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
              <div><label class="form-label">Staff ID</label><p style="font-weight:600;"><?= $dbUser['tenant_id'] ?? 'DMY-001' ?></p></div>
              <div><label class="form-label">Role</label><p style="font-weight:600;">Damayan Manager</p></div>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- Profile Modal and Scripts same as Apartment... -->
