...
<aside class="sidebar" id="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="<?= url('/admin/apartment/analytics') ?>" class="nav-item <?= ($active_page ?? '') == 'apartment_analytics' ? 'active' : '' ?>" data-tooltip="Insights & Analytics">
      <svg viewBox="0 0 24 24" fill="currentColor"><path d="M19 3H5c-1.1 0-2 .9-2 2v14c0 1.1.9 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zM9 17H7v-7h2v7zm4 0h-2V7h2v7zm4 0h-2v-4h2v4z" /></svg>
      <span class="nav-item-label">Analytics & Insights</span>
    </a>
