...
<head>
  ...
  <title>ISCAG MIS — Maintenance Management</title>
      ...
      <div class="top-bar">
        <div class="top-bar-left">
          ...
          <div>
            ...
            <div class="top-bar-subtitle">Facility repairs and tenant service management</div>
          </div>
        </div>
  ...
  <script>
    ...
    function rejectMaintenance(id) {
      ...
      if (reason !== null) {
        ...
        form.method = 'POST';
        form.action = '<?= url("/admin/apartment/maintenance/reject") ?>?id=' + id;
