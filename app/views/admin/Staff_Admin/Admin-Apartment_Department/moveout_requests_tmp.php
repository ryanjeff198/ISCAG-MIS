...
<body>
            ...
            <div class="settlement-card">
               ...
               <div style="margin-top: 20px; display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                  ...
                  <div class="form-group">
                     ...
                     <div class="input-with-icon">
                        <span class="input-icon-prefix">₱</span>
                        <input type="number" name="utility" id="set-utility" class="mis-input" step="0.01" value="0" oninput="calculateRefund()"></div><span id="balance-info" style="font-size: 0.65rem; color: var(--primary); font-weight: 600; display: none; margin-top: 5px;"><svg viewBox="0 0 24 24" style="width:12px;height:12px;fill:currentColor;vertical-align:middle;"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z"/></svg> System-generated outstanding balance</span>
                  </div>
               </div>
            </div>
  ...
  <script>
    ...
    function calculateRefund() {
       ...
       const totalDeductions = dmg + util;
