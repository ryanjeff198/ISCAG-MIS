...
<head>
  ...
  <title>ISCAG MIS — Da'wah Female Staff Admin</title>
  <link rel="icon" type="image/x-icon" href="<?= asset('assets/favicon_io/favicon.ico') ?>">
  <meta name="description" content="Staff Admin dashboard for Da'wah Female department management" />
...
<body>
  <div class="app-wrapper">
    <?php include BASE_PATH . '/app/views/admin/Staff_Admin/Admin-Dawah_Female_Department/sidebar.php'; ?>

    <main class="main-content">
      <div class="top-bar">
        <div class="top-bar-left">
          <div>
            <div class="top-bar-title">Da'wah (Female) Dashboard</div>
            <div class="top-bar-subtitle">Welcome back, <?= htmlspecialchars(explode(' ',trim($dbUser['first_name']??'Staff'))[0]) ?>. Managing female conversions & counseling.</div>
          </div>
        </div>
      ...
      <div class="page-body">
        <div class="db">
          ...
          <div class="db-section">
            <div class="card">
              <div class="card-head">
                <div><div class="card-title">Recent Conversions</div><div class="card-sub">Latest female conversion records</div></div>
              </div>
