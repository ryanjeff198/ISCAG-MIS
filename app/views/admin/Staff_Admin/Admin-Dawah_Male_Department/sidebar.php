<aside class="sidebar" id="sidebar">
  ...
  <div class="sidebar-header">
    <div class="sidebar-brand">
      ...
      <div class="brand-text"><strong>ISCAG MIS</strong><span>Da'wah (Male)</span></div>
    </div>
  </div>
  <div class="sidebar-user">
    ...
    <div class="user-info">
      <strong id="nav-name"><?= trim(($dbUser['first_name'] ?? '') . ' ' . ($dbUser['last_name'] ?? '')) ?: 'Da\'wah Male Staff' ?></strong>
      <span>Staff Admin</span>
    </div>
  </div>
  <nav class="sidebar-nav">
    <div class="nav-section-label">Admin</div>
    <a href="<?= url('/admin/dawah/male') ?>" class="nav-item <?= ($active_page ?? '') == 'dashboard' ? 'active' : '' ?>" data-tooltip="Dashboard">
