...
$is_finance_open = in_array($active_page, ['apartment_payment', 'apartment_soa', 'reports']);
$is_comm_open = in_array($active_page, ['daawah_records', 'damayan_records', 'notifications', 'apartment_records']);
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <div class="nav-dropdown-wrap" id="finance-wrap">
            <button class="nav-dropdown-trigger <?= $is_finance_open ? 'open' : '' ?>" id="finance-trigger" data-href="<?= url('/admin/staff_admin/apartment/payment') ?>">
            ...
            <div class="nav-dropdown <?= $is_finance_open ? 'open' : '' ?>" id="finance-menu">
                <a href="<?= url('/admin/staff_admin/apartment/payment') ?>" class="<?= $active_page === 'apartment_payment' ? 'active-submenu' : '' ?>">Billing & Payments</a>
                <a href="<?= url('/admin/staff_admin/apartment/soa') ?>" class="<?= $active_page === 'apartment_soa' ? 'active-submenu' : '' ?>">SOA Dashboard</a>
        ...
        <div class="nav-dropdown-wrap" id="comm-wrap">
            ...
            <div class="nav-dropdown <?= $is_comm_open ? 'open' : '' ?>" id="comm-menu">
                <a href="<?= url('/admin/mis_admin/apartment_records') ?>" class="<?= $active_page === 'apartment_records' ? 'active-submenu' : '' ?>">Apartment Inventory</a>
                <a href="<?= url('/admin/mis_admin/daawah_records') ?>" class="<?= $active_page === 'daawah_records' ? 'active-submenu' : '' ?>">Da'wah Records</a>
                <a href="<?= url('/admin/mis_admin/damayan_records') ?>" class="<?= $active_page === 'damayan_records' ? 'active-submenu' : '' ?>">Burial Records</a>
